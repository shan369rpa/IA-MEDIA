...
3) pip install git+https://github.com/m-bain/whisperx.git --no-deps
2) pip install nltk av ctranslate2 opentelemetry-api opentelemetry-sdk opentelemetry-exporter-otlp matplotlib ipython
1) pip install torch==2.3.1+cu121 torchvision==0.18.1+cu121 torchaudio==2.3.1+cu121 --index-url https://download.pytorch.org/whl/cu121
ffmpeg-python