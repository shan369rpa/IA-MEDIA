...
scp ./migrations/003_create_v3_schema.sql root@180.93.137.58:/root/
docker cp /root/003_create_v3_schema.sql ia-media-db-pgvector:/tmp/migration_003.sql
docker exec -it ia-media-db-pgvector psql -U ia_media_admin -d ia_media_db -f /tmp/migration_003.sql
docker exec ia-media-db-pgvector rm /tmp/migration_003.sql
